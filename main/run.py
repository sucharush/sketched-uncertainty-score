...
from main.run_util import run_experiment
import warnings
warnings.simplefilter(action='ignore', category=FutureWarning)

def run_and_report(model_key, ood_name, n_runs=5):
    ...
    config = {
        ...
        "ood_size": 500,
        "device": device,
        "name": f"{model_key.upper()} on {id_dataset.upper()} vs {ood_name.upper()}"
    }
...
if __name__ == "__main__":
    ...
    run_and_report(args.model, args.ood, args.runs)
